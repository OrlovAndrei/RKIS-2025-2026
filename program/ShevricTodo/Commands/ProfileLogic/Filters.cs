...
internal static class Filters
{
	...
	public static async Task<IQueryable<Profile>> FilterTasksContainsAsync(
	...
	public static async Task<IQueryable<Profile>> FilterTasksEndsWithAsync(
	this Task<IQueryable<Profile>> profileQuery,
	Profile searchTemplate)
	{
		IQueryable<Profile> query = await profileQuery;
	...
	public static async Task<IQueryable<Profile>> FilterTasksStartsWithAsync(
	this Task<IQueryable<Profile>> profileQuery,
	Profile searchTemplate)
	{
		IQueryable<Profile> query = await profileQuery;
	...
	public static async Task<IQueryable<Profile>> FilterOrderByAsync(
		this Task<IQueryable<Profile>> profileQuery,
	...
	public static async Task<IQueryable<Profile>> FilterOrderByDescAsync(
		this Task<IQueryable<Profile>> profileQuery,
		Options optionsOrders)
	{
		var query = await profileQuery;
	...
	public static async Task<IQueryable<Profile>> FilterIdMinAndMaxAsync(
		this Task<IQueryable<Profile>> profileQuery,
		int? min, int? max,
		Options option)
	{
	...
	public static async Task<IQueryable<Profile>> FilterIdEqualsAsync(
		this Task<IQueryable<Profile>> profileQuery,
		Profile searchTemplate)
	{
		var query = await profileQuery;
	...
	public static async Task<IQueryable<Profile>> FilterDateMinAndMaxAsync(
		this Task<IQueryable<Profile>> profileQuery,
	...
	public static async Task<IQueryable<Profile>> FilterDateEqualsAsync(
		this Task<IQueryable<Profile>> profileQuery,
		Profile searchTemplate)
	{
		var query = await profileQuery;
	...
	public static async Task<IQueryable<Profile>> FilterTopAsync(
		this Task<IQueryable<Profile>> profileQuery,
		int top) => (await profileQuery).Take(top);
	public static async Task<IQueryable<Profile>> ToAsync(
		this IQueryable<Profile> profileQuery) => profileQuery;
	public static async Task<IQueryable<Profile>> StartFilter(
		this DbSet<Profile> tasks) => await tasks.AsQueryable().ToAsync();
	public static async Task<IEnumerable<Profile>> FinishFilter(
