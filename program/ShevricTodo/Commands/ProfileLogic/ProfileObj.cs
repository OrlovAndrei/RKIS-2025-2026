...
internal class ProfileObj
{
	...
	protected static async Task<int> AddNewProfile(
		Profile newProfile)
	{
		using (Todo db = new())
		{
	...
	/// <returns>Количество изменений</returns>
	protected static async Task<int> AddNewProfiles(
	...
	protected internal static async Task<int> RemoveProfile(
		Profile profile)
	{
		using (Todo db = new())
		{
	...
	protected internal static async Task<int> RemoveProfiles(
	...
	protected internal static async Task<int> UpdateProfile(
		Profile profile)
	{
		using (Todo db = new())
		{
	...
	protected internal static async Task<int> UpdateProfiles(
		IEnumerable<Profile> profiles)
	{
		using (Todo db = new())
		{
	...
	internal static async Task<bool> CheckPassword(
		Func<string, string> inputPassword,
		Profile profile) => profile.HashPassword ==
