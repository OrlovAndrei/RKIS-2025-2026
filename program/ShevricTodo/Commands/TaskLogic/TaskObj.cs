...
internal class TaskObj
{
	...
	protected internal static async Task<int> AddNewTask(
		TaskTodo newTask)
	{
		using (Todo db = new())
		{
	...
	/// <returns>A task that represents the asynchronous operation. The task result contains the number of state entries written to
	/// the database.</returns>
	protected internal static async Task<int> AddNewTasks(
	...
	protected internal static async Task<int> RemoveTask(
		TaskTodo task)
	{
		using (Todo db = new())
		{
	...
	protected internal static async Task<int> RemoveTasks(
	...
	protected internal static async Task<int> UpdateTask(
		TaskTodo task)
	{
		using (Todo db = new())
		{
	...
	protected internal static async Task<int> UpdateTasks(
		IEnumerable<TaskTodo> tasks)
	{
		using (Todo db = new())
		{
