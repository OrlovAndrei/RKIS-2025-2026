...
internal partial class Remove
{
	...
	Profile searchTemplate) => await Done(searchProfile: searchProfile,
	...
	public static async Task<(int result, Profile? deletedProfile)> DoneContains(
		Profile searchTemplate) => await Done(searchProfile: Search.SearchProfilesContains,
			searchTemplate: searchTemplate
			);
	public static async Task<(int result, Profile? deletedProfile)> DoneStartsWith(
		Profile searchTemplate) => await Done(searchProfile: Search.SearchProfilesStartsWith,
			searchTemplate: searchTemplate
			);
	public static async Task<(int result, Profile? deletedProfile)> DoneEndsWith(
		Profile searchTemplate) => await Done(searchProfile: Search.SearchProfilesEndsWith,
			searchTemplate: searchTemplate
			);
}