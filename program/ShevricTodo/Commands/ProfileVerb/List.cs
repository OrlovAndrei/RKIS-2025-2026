...
internal partial class List
{
	...
	IEnumerable<Database.Profile> profiles) => await PrintProfiles(
	...
	Func<string[], IEnumerable<string[]>, string?, Task> printTable) => await PrintProfiles(printTable, await GetAllProfile());
	public static async Task PrintAllProfiles() => await PrintAllProfiles(
			printTable: Input.WriteToConsole.PrintTable);
	public static async Task PrintTaskCountsByProfile(
	IEnumerable<Database.Profile> profiles) => await PrintTaskCountsByProfile(profiles: profiles,
			printTable: Input.WriteToConsole.PrintTable);
	/// <summary>
	...
	public static async Task PrintTaskCountsByAllProfile() => await PrintTaskCountsByAllProfile(printTable: Input.WriteToConsole.PrintTable);
}
