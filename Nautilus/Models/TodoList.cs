...
namespace TodoApp.Models
{
	public class TodoList
	{
		...
		{
			return GetTable(_items,_showIndex,_showStatus,_showDate);
		}
		public static string GetTable (List<TodoItem> items,bool _showIndex = true, bool _showStatus = true, bool _showDate = true)
		{
