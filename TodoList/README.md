...
# Лекция 5 Сетевое программирование


### Серверный проект (TodoList.Server)

**Новый проект:** `TodoList.Server`

#### Технологии:
- `HttpListener` — встроенный HTTP-сервер в .NET
- Асинхронная обработка запросов


# Лекция 6 Работа с БД

### Создан SqliteDataStorage
