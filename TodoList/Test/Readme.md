...
Авторы: Прокопенко Алексей и Мороз Лев
Группа: 3834.9
...
Вести логин: Arbuz
Пароль: 2007
При запросе ввести имя: Alex
Ввести фамилию: Prokopenko
Ввести год рождения: 2007
Ожидаемый результат:
Создан пользователь "Alex Prokopenko"
В консоль выводится сообщение с данными пользователя
В папке data создан файл profile.txt с содержимым "Alex;Prokopenko;2007"
Скриншоты:
TC-1.PNG
...
В консоль выводится сообщение "Вход выполнен. Профиль: Alex Prokopenko, возраст 19 (логин: Arbuz)"
Скриншоты:
TC-2.PNG
...
Ожидаемый результат:
Отображаются данные текущего пользователя "Alex, возраст 19 (логин: Arbuz)"
Скриншоты:
TC-3.PNG
